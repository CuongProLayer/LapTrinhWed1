...
public class AcademicYearWebController {
    ...
    public AcademicYearWebController(AcademicYearService service) {
    ...
    public String createForm(Model model) {
        model.addAttribute("yearReq", new AcademicYearRequest());
    ...
    public String create(@ModelAttribute AcademicYearRequest request, RedirectAttributes ra) {
        try {
            ...
            ra.addFlashAttribute("successMsg", "Thêm năm học thành công!");
        } catch (Exception e) {
    ...
    public String editForm(@PathVariable UUID id, Model model) {
        ...
        req.setStartYear(res.getStartYear());
        req.setEndYear(res.getEndYear());
        model.addAttribute("yearReq", req);
    ...
    public String delete(@PathVariable UUID id, RedirectAttributes ra) {
        ...
        ra.addFlashAttribute("successMsg", "Xóa thành công!");
        return "redirect:/academic-years";
    }
}
