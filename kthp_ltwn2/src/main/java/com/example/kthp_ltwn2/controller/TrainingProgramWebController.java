...
public class TrainingProgramWebController {
    ...
    public String create(@ModelAttribute TrainingProgramRequest request, RedirectAttributes ra) {
        try {
            ...
            ra.addFlashAttribute("successMsg", "Thêm chương trình học thành công!");
        } catch (Exception e) {
    ...
    public String editForm(@PathVariable UUID id, Model model) {
        ...
        req.setMajorId(res.getMajorId());
        req.setDegreeLevel(res.getDegreeLevel());
        model.addAttribute("progReq", req);
        model.addAttribute("progId", id);
